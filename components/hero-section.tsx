  ...
  return (
    <section className="relative overflow-hidden bg-primary px-4 pb-16 pt-20 md:px-6 md:pb-24 md:pt-28">
      ...
      <div className="relative mx-auto max-w-3xl text-center">
        {/* Badges: Seminario + Instituto */}
        <div className="mb-6 flex items-center justify-center gap-2 flex-wrap">
          <div className="inline-flex items-center gap-2 rounded-full border border-primary-foreground/20 bg-primary-foreground/10 px-4 py-2">
            <BookOpen className="h-4 w-4 text-primary-foreground/80" />
            <span className="text-sm font-medium text-primary-foreground">Seminario</span>
          </div>
          <div className="inline-flex items-center gap-2 rounded-full border border-primary-foreground/20 bg-primary-foreground/10 px-4 py-2">
            <GraduationCap className="h-4 w-4 text-primary-foreground/80" />
            <span className="text-sm font-medium text-primary-foreground">Instituto</span>
          </div>
        </div>

        <h2 className="text-balance font-serif text-4xl font-bold leading-tight text-primary-foreground md:text-5xl lg:text-6xl">
          Estudia las Escrituras a tu ritmo
        </h2>
