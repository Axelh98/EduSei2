...
export const leccionesResumidasAT_1_5: Lesson[] = [
  {
    id: "leccion-1",
...
Este año, la pregunta no es si el Antiguo Testamento tiene que ver con Cristo. La pregunta es: ¿estás dispuesto a buscarlo activamente cada vez que abras esas páginas?`,
      },
      {
        ...
        texto: "Hermanos y hermanas, somos la esencia del plan del Padre Celestial y la razón de la misión de nuestro Salvador. […] Para mí, ningún libro de Escritura ilustra esto más claramente que mi estudio del Antiguo Testamento. Capítulo tras capítulo descubrimos ejemplos de cómo el Padre Celestial y Jehová se involucran de manera íntima en nuestra vida.",
        link: "https://www.churchofjesuschrist.org/study/general-conference/2022/04/44ringwood?lang=spa&id=p7-p8#p7",
        // ✅ Corregido: la versión anterior tenía inserciones entre corchetes que no son del orador y cambiaba "Jehová" por "Jesucristo". El link ya era correcto.
      },
      {
        tipo: "enseñanza",
        ...
        link: "https://www.churchofjesuschrist.org/study/general-conference/2023/04/51oaks?lang=spa&id=p2#p2",
      },
      {
        tipo: "escrituras",
        citas: [
          ...
          },
          {
            ...
            texto: "Y comenzando desde Moisés, y siguiendo por todos los profetas, les declaraba en todas las Escrituras lo que de él decían.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/nt/luke/24?lang=spa&id=p27#p27",
          },
          {
            referencia: "3 Nefi 23:1",
            texto: "Una orden os doy: Escudriñad diligentemente las palabras de Isaías; porque en verdad él dijo muchas cosas concernientes a mi pueblo.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/bofm/3-ne/23?lang=spa&id=p1#p1",
          },
          {
            referencia: "Amós 3:7",
  ...
  },
  {
    ...
    secciones: [
      ...
      },
      {
        ...
        link: "https://www.churchofjesuschrist.org/study/general-conference/2021/04/35oaks?lang=spa&id=p2#p2",
      },
      {
        tipo: "enseñanza",
        ...
        citas: [
          {
            ...
            texto: "Esta es mi obra y mi gloria: llevar a cabo la inmortalidad y la vida eterna del hombre.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/pgp/moses/1?lang=spa&id=p39#p39",
          },
          {
            referencia: "Abraham 3:22–23",
            texto: "El Señor me mostró las inteligencias que fueron organizadas antes de que el mundo existiera; y entre todas estas había muchas de las nobles y grandes.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/pgp/abr/3?lang=spa&id=p22-p23#p22",
          },
          {
            referencia: "Moisés 4:1–2",
            texto: "Satanás... dijo: He aquí, yo aquí estoy, envíame a mí, y seré tu hijo, y redimiré a toda la humanidad, de tal suerte que no se perderá ni una sola alma. Pero el Unigénito dijo: Padre, hágase tu voluntad.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/pgp/moses/4?lang=spa&id=p1-p2#p1",
          },
          {
            referencia: "Alma 34:32",
            texto: "Esta vida es el tiempo para los hombres de prepararse para encontrarse con Dios; sí, he aquí, el día de esta vida es el día para los hombres de ejecutar sus labores.",
  ...
  },
  {
    ...
    secciones: [
      ...
      },
      {
        ...
        texto: "Usted simplemente viva digno del Reino Celestial, y la situación de su familia será más maravillosa de lo que pueda imaginar. Testifico que, a medida que vivan de manera que sean dignos del Reino Celestial, esa promesa profética se cumplirá para ustedes.",
        link: "https://www.churchofjesuschrist.org/study/liahona/2016/08/the-hope-of-eternal-family-love?lang=spa&id=p9-p11#p9",
        // ✅ Verificado contra el manual oficial de esta lección (cita textualmente este discurso: "The Hope of Eternal Family Love", Ensign/Liahona, agosto de 2016, pág. 5). Mi corrección anterior en esta conversación estaba mal: la fuente de agosto 2016 SÍ es la correcta (Eyring repitió esta misma anécdota en 2019, lo cual me hizo confundir la fuente). Solo hacía falta completar el link con el discurso específico.
      },
      {
        tipo: "enseñanza",
      ...
      },
      {
        ...
        citas: [
          {
            referencia: "Génesis 24:12, 14",
            texto: "Y dijo: Oh Jehová, Dios de mi señor Abraham... Sea, pues, que la doncella a quien yo dijere: Inclina tu cántaro, te ruego... sea la que tú has destinado para tu siervo Isaac.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/ot/gen/24?lang=spa&id=p12,p14#p12",
          },
          {
            referencia: "Doctrina y Convenios 131:1–4",
            texto: "En el grado celestial de matrimonio hay tres cielos o grados; y para obtener el más elevado, un hombre debe entrar en este orden del sacerdocio [el nuevo y sempiterno convenio del matrimonio]; y si no lo hace, no puede obtenerlo.",
          ...
          },
          {
            ...
            texto: "Si un hombre se casa con una mujer por mi palabra, que es mi ley, y por el nuevo y sempiterno convenio, y esto se sella sobre ellos por el Espíritu Santo de la promesa... tendrán herencia y exaltación en los dominios eternos.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/dc-testament/dc/132?lang=spa&id=p19#p19",
          },
          {
            referencia: "Génesis 24:7",
            texto: "Jehová enviará su ángel delante de ti, y tomarás de allí mujer para mi hijo.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/ot/gen/24?lang=spa&id=p7#p7",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    secciones: [
      ...
      },
      {
        ...
        link: "https://www.churchofjesuschrist.org/study/general-conference/2024/04/34carpenter?lang=spa&id=p5#p5",
      },
      {
        tipo: "escrituras",
        citas: [
          {
            referencia: "Génesis 25:32–33",
            texto: "Y respondió Esaú: He aquí yo me voy a morir; ¿para qué, pues, me servirá la primogenitura? Entonces Jacob dijo: Júramelo en este día. Y él le juró, y vendió a Jacob su primogenitura.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/ot/gen/25?lang=spa&id=p32-p33#p32",
          },
          {
            referencia: "Hebreos 12:16",
            texto: "No sea que haya alguno fornicario, o profano, como Esaú, que por una sola comida vendió su primogenitura.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/nt/heb/12?lang=spa&id=p16#p16",
          },
          {
            referencia: "1 Corintios 2:9",
            texto: "Antes bien, como está escrito: Cosas que ojo no vio, ni oído oyó, ni han subido al corazón del hombre, son las que Dios ha preparado para los que le aman.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/nt/1-cor/2?lang=spa&id=p9#p9",
          },
          {
            referencia: "Doctrina y Convenios 76:51–53",
            texto: "Ellos son los que recibieron el testimonio de Jesús, y creyeron en su nombre y fueron bautizados... Los cuales vencen por la fe y están sellados por el Espíritu Santo de la promesa.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/dc-testament/dc/76?lang=spa&id=p51-p53#p51",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    secciones: [
      ...
      },
      {
        ...
        link: "https://www.churchofjesuschrist.org/study/general-conference/2020/10/28uchtdorf?lang=spa&id=p16#p16",
        // ✅ Corregido el link: el manual de esta lección cita "28uchtdorf", no "47uchtdorf".
      },
      {
        tipo: "enseñanza",
      ...
      },
      {
        ...
        citas: [
          {
            referencia: "Génesis 39:2–3",
            texto: "Mas Jehová estaba con José, y fue varón próspero; y estaba en la casa de su amo el egipcio. Y vio su amo que Jehová estaba con él, y que todo lo que él hacía, Jehová lo hacía prosperar en su mano.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/ot/gen/39?lang=spa&id=p2-p3#p2",
          },
          {
            referencia: "Génesis 50:20",
            texto: "Vosotros pensasteis mal contra mí, mas Dios lo encaminó a bien, para hacer lo que vemos hoy, para mantener en vida a mucho pueblo.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/ot/gen/50?lang=spa&id=p20#p20",
          },
          {
            ...
            link: "https://www.churchofjesuschrist.org/study/scriptures/nt/rom/8?lang=spa&id=p28#p28",
          },
          {
            referencia: "Doctrina y Convenios 90:24",
            texto: "Buscad diligentemente, orad siempre y estad creyendo, y todas las cosas redundarán en vuestro bien, si andáis rectamente y os acordáis del convenio que habéis hecho.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/dc-testament/dc/90?lang=spa&id=p24#p24",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    secciones: [
      ...
      {
        tipo: "enseñanza",
        autor: "Temas y preguntas — Biblioteca del Evangelio",
      ...
      },
      {
        ...
        citas: [
          {
            referencia: "Génesis 39:9",
            texto: "¿Cómo, pues, haría yo este grande mal y pecaría contra Dios?",
            link: "https://www.churchofjesuschrist.org/study/scriptures/ot/gen/39?lang=spa&id=p9#p9",
          },
          {
            referencia: "1 Corintios 6:18–20",
            texto: "Huid de la fornicación. El cuerpo no es para la fornicación, sino para el Señor... ¿O ignoráis que vuestro cuerpo es templo del Espíritu Santo, el cual está en vosotros? ... Glorificad, pues, a Dios en vuestro cuerpo.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/nt/1-cor/6?lang=spa&id=p18-p20#p18",
          },
          {
            referencia: "Alma 39:9",
            texto: "Ahora bien, hijo mío, no deseo que esto sea la causa de tu muerte; pero sí deseo que hagas penitencia y te abstengas de tus iniquidades, y te conviertas al Señor tu Dios.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/bofm/alma/39?lang=spa&id=p9#p9",
          },
          {
            referencia: "Doctrina y Convenios 121:45",
            texto: "Deja que la virtud adorne tus pensamientos sin cesar; entonces tu confianza se volverá fuerte en la presencia de Dios.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/dc-testament/dc/121?lang=spa&id=p45#p45",
          },
        ],
      },
      {
        ...
        citas: [
          {
            ...
            link: "https://www.churchofjesuschrist.org/study/scriptures/ot/prov/16?lang=spa&id=p3#p3",
          },
          {
            referencia: "Doctrina y Convenios 58:27–28",
            texto: "Los hombres deben ser diligentemente ocupados en la buena causa, y hacer muchas cosas por su propia voluntad, y llevar a cabo mucha justicia; porque el poder está en ellos, en los cuales están ordenados de Dios.",
          ...
          },
          {
            ...
            texto: "Buscad palabras de sabiduría de los mejores libros; buscad aprender y también por la fe.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/dc-testament/dc/88?lang=spa&id=p118#p118",
          },
          {
            referencia: "2 Nefi 25:23",
            texto: "Porque es por gracia que nos salvamos, después de hacer cuanto podamos.",
        ...
        citas: [
          {
            ...
            texto: "Edificad vuestro fundamento sobre la roca de nuestro Redentor, que es Cristo, el Hijo de Dios, a fin de que cuando el diablo envíe sus vientos poderosos, sí, sus dardos en el torbellino, sí, cuando todo su granizo y su tormenta feroz os golpeen, no tenga poder sobre vosotros.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/bofm/hel/5?lang=spa&id=p12#p12",
          },
          {
            referencia: "Doctrina y Convenios 11:22",
            texto: "No procures declarar mi palabra, sino busca primero obtener mi palabra, y entonces se te soltará la lengua; entonces, si lo deseas, tendrás mi Espíritu y mi palabra.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/dc-testament/dc/11?lang=spa&id=p22#p22",
          },
          {
            referencia: "Moroni 10:4–5",
            texto: "Si pedís con sincero corazón, con verdadera intención, teniendo fe en Cristo, Él os manifestará la verdad por el poder del Espíritu Santo. Y por el poder del Espíritu Santo podréis conocer la verdad de todas las cosas.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/bofm/moro/10?lang=spa&id=p4-p5#p4",
          },
          {
            referencia: "2 Timoteo 3:16–17",
            texto: "Toda la Escritura es inspirada divinamente y útil para enseñar, para redargüir, para corregir, para instruir en justicia, a fin de que el hombre de Dios sea perfecto, enteramente preparado para toda buena obra.",
  ...
  },
  {
    ...
    secciones: [
      ...
      },
      {
        ...
        citas: [
          {
            referencia: "Moroni 7:16",
            texto: "Todo aquello que invite a hacer el bien y a persuadir a creer en Cristo es enviado por el poder y el don de Cristo; por tanto, podéis saber con perfecta certeza que es de Dios.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/bofm/moro/7?lang=spa&id=p16#p16",
          },
          {
            referencia: "Doctrina y Convenios 88:124",
            texto: "Cesad de la ociosidad; cesad de vuestras palabras inmundas y de las risas; cesad del sueño más de lo necesario; retiraos a tiempo para que no os canséis.",
          ...
          },
          {
            ...
            texto: "Todo lo que es verdadero, todo lo honesto, todo lo justo, todo lo puro, todo lo amable, todo lo que es de buen nombre... en esto pensad.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/nt/philip/4?lang=spa&id=p8#p8",
          },
          {
            referencia: "Doctrina y Convenios 121:45",
            texto: "Deja que la virtud adorne tus pensamientos sin cesar; entonces tu confianza se volverá fuerte en la presencia de Dios.",
  ...
  },
  {
    ...
    secciones: [
      ...
      },
      {
        ...
        citas: [
          {
            referencia: "Génesis 45:5–7",
            texto: "Ahora, pues, no os entristezcáis, ni os pese de haberme vendido acá; porque para preservación de vida me envió Dios delante de vosotros. Dios me envió delante de vosotros para preservaros posteridad sobre la tierra.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/ot/gen/45?lang=spa&id=p5-p7#p5",
          },
          {
            referencia: "Doctrina y Convenios 64:10",
            texto: "Es preciso que perdonéis a todos los hombres.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/dc-testament/dc/64?lang=spa&id=p10#p10",
          },
          {
            referencia: "Lucas 23:34",
            texto: "Y Jesús decía: Padre, perdónalos, porque no saben lo que hacen.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/nt/luke/23?lang=spa&id=p34#p34",
          },
          {
            referencia: "Efesios 4:31–32",
            texto: "Quitense de vosotros toda amargura, enojo, ira, gritería y maledicencia, y toda malicia. Antes sed benignos unos con otros, misericordiosos, perdonándoos unos a otros, como Dios también os perdonó en Cristo.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/nt/eph/4?lang=spa&id=p31-p32#p31",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    secciones: [
      ...
      },
      {
        ...
        citas: [
          {
            referencia: "2 Nefi 3:14–15",
            texto: "Su nombre será como el de su padre; y será igual que yo, porque la cosa que el Señor llevará a cabo por su mano, por el poder del Señor dará fruto de alabanza a él.",
          ...
          },
          {
            ...
            texto: "José Smith, el Profeta y Vidente del Señor, ha hecho más por la salvación de los hombres en este mundo que cualquier otro hombre que haya vivido en él, excepto solamente Jesús.",
      ...
      },
      {
        ...
        citas: [
          ...
          },
          {
            ...
            texto: "Despreciado y desechado entre los hombres, varón de dolores, experimentado en quebranto... Mas él herido fue por nuestras rebeliones, molido por nuestros pecados; el castigo de nuestra paz fue sobre él, y por su llaga fuimos nosotros curados.",
    ...
    secciones: [
      ...
      },
      {
        ...
        citas: [
          {
            referencia: "Doctrina y Convenios 88:118",
            texto: "Buscad palabras de sabiduría de los mejores libros; buscad aprender, sí, buscad palabras de sabiduría de los mejores libros; buscad conocimiento, tanto por el estudio como por la fe.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/dc-testament/dc/88?lang=spa&id=p118#p118",
          },
          {
          ...
          {
            referencia: "Daniel 1:17, 20",
            texto: "A estos cuatro jóvenes Dios les dio conocimiento e inteligencia en todas las letras y ciencias... En todo asunto de sabiduría e inteligencia... los halló diez veces mejores.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/ot/dan/1?lang=spa&id=p17,p20#p17",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    type: "Antiguo Testamento - Ven Sigueme",
    description: "",
    chapterUrl: "https://www.churchofjesuschrist.org/study/manual/old-testament-seminary-student-manual-2026/13-exodus-1-6/131-exodus-1?lang=spa",
    questions: [],
    secciones: [
      {
        tipo: "contexto",
      ...
      },
      {
        ...
        link: "https://www.churchofjesuschrist.org/study/general-conference/2017/04/drawing-the-power-of-jesus-christ-into-our-lives?lang=spa&id=p18#p18",
      },
      {
        tipo: "enseñanza",
        autor: "Presidente Thomas S. Monson",
        fuente: "Liahona, mayo de 2014, pág. 69",
        texto: "Todos sentiremos temor, seremos ridiculizados y afrontaremos oposición. Tengamos todos nosotros el valor de desafiar la opinión popular, la valentía de defender nuestros principios. El tener valor, no el transigir, es lo que trae la aprobación de Dios.",
        link: "https://www.churchofjesuschrist.org/study/general-conference/2014/04/be-strong-and-of-a-good-courage?lang=spa&id=p29#p29",
        // ✅ Corregido: la cita de Maxwell no está en el manual oficial de esta lección ni pude verificarla. Se reemplazó por la cita real de Monson ("Esfuércense y sean valientes") que el manual sí usa para este principio.
      },
      {
        tipo: "escrituras",
        citas: [
          {
            referencia: "Éxodo 1:17",
            texto: "Pero las parteras temieron a Dios, y no hicieron como les mandó el rey de Egipto, sino que preservaron la vida a los niños.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/ot/ex/1?lang=spa&id=p17#p17",
          },
          {
            referencia: "Éxodo 1:20–21",
            texto: "Y Dios hizo bien a las parteras; y el pueblo se multiplicó y se fortaleció en gran manera. Y por cuanto las parteras temieron a Dios, él prosperó sus familias.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/ot/ex/1?lang=spa&id=p20-p21#p20",
          },
          {
            referencia: "Hechos 5:29",
            texto: "Respondiendo Pedro y los apóstoles, dijeron: Es necesario obedecer a Dios antes que a los hombres.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/nt/acts/5?lang=spa&id=p29#p29",
          },
          {
            referencia: "Josué 1:9",
            texto: "¿No te lo he mandado yo? Esfuérzate y sé valiente; no temas ni desmayes, porque Jehová tu Dios estará contigo en dondequiera que vayas.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/ot/josh/1?lang=spa&id=p9#p9",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    type: "Antiguo Testamento - Ven Sigueme",
    description: "",
    chapterUrl: "https://www.churchofjesuschrist.org/study/manual/old-testament-seminary-student-manual-2026/13-exodus-1-6/132-exodus-2-4?lang=spa",
    questions: [],
    secciones: [
      {
        tipo: "contexto",
      ...
      },
      {
        ...
        citas: [
          {
            referencia: "Éxodo 3:11–12",
            texto: "Entonces Moisés respondió a Dios: ¿Quién soy yo para que vaya a Faraón, y saque de Egipto a los hijos de Israel? Y él respondió: Ve, porque yo estaré contigo.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/ot/ex/3?lang=spa&id=p11-p12#p11",
          },
          {
            referencia: "Éxodo 3:14",
            texto: "YO SOY EL QUE SOY. Así dirás a los hijos de Israel: YO SOY me envió a vosotros.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/ot/ex/3?lang=spa&id=p14#p14",
          },
          {
            referencia: "Éter 12:27",
            texto: "Si se humillan ante mí, y tienen fe en mí, haré que las cosas débiles se vuelvan fuertes para ellos.",
  ...
  },
  {
    ...
    type: "Antiguo Testamento - Ven Sigueme",
    description: "",
    chapterUrl: "https://www.churchofjesuschrist.org/study/manual/old-testament-seminary-student-manual-2026/13-exodus-1-6/133-exodus-5-6?lang=spa",
    questions: [],
    secciones: [
      {
        tipo: "contexto",
      ...
      },
      {
        ...
        citas: [
          {
            referencia: "Éxodo 6:2, 6–8",
            texto: "Habló todavía Dios a Moisés, y le dijo: Yo soy Jehová. Os sacaré de debajo de las tareas pesadas de Egipto, y os libraré de su servidumbre, y os redimiré con brazo extendido.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/ot/ex/6?lang=spa&id=p2,p6-p8#p2",
          },
          {
            referencia: "Romanos 8:28",
          ...
          {
            referencia: "Doctrina y Convenios 121:7–8",
            texto: "Hijo mío, paz sea a tu alma; tu adversidad y tus aflicciones serán tan solo un pequeño momento; y luego, si las soportas bien, Dios te ensalzará en las alturas.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/dc-testament/dc/121?lang=spa&id=p7-p8#p7",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    secciones: [
      ...
      },
      {
        ...
        citas: [
          {
            referencia: "Doctrina y Convenios 109:22",
            texto: "Que toda la gente que entrare en el umbral de la casa del Señor sepa que tú eres el que la has santificado y que es tu casa, un lugar de tu santidad.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/dc-testament/dc/109?lang=spa&id=p22#p22",
          },
          {
            referencia: "Salmo 84:1–2",
            texto: "¡Cuán amables son tus moradas, oh Jehová de los ejércitos! Anhela mi alma y aun ardientemente desea los atrios de Jehová; mi corazón y mi carne cantan al Dios vivo.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/ot/ps/84?lang=spa&id=p1-p2#p1",
          },
          {
            referencia: "Doctrina y Convenios 131:1–4",
            texto: "En el grado celestial de matrimonio hay tres cielos o grados; y para obtener el más elevado, un hombre debe entrar en este orden del sacerdocio.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/dc-testament/dc/131?lang=spa&id=p1-p4#p1",
          },
          {
            referencia: "Ezequiel 37:26–27",
            texto: "Y haré con ellos pacto de paz... y mi santuario estará en medio de ellos para siempre. Sobre ellos tendrá mi morada, y yo seré a ellos por Dios, y ellos me serán por pueblo.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/ot/ezek/37?lang=spa&id=p26-p27#p26",
          },
        ],
      },
      {
        ...
        citas: [
          {
            ...
            texto: "Le dijo Jesús: Yo soy la resurrección y la vida; el que cree en mí, aunque esté muerto, vivirá. Y todo aquel que vive y cree en mí, no morirá eternamente.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/nt/john/11?lang=spa&id=p25-p26#p25",
          },
          {
            referencia: "Alma 7:11–12",
            texto: "Y él irá, sufriendo dolores y aflicciones y tentaciones de todo género; y esto a fin de que se cumpla la palabra que dice que tomará sobre sí los dolores y las enfermedades de su pueblo.",
          ...
          },
          {
            ...
            texto: "Mas ahora Cristo ha resucitado de los muertos; primicias de los que durmieron es hecho. Porque así como en Adán todos mueren, también en Cristo todos serán vivificados.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/nt/1-cor/15?lang=spa&id=p20-p22#p20",
          },
          {
            referencia: "Job 19:25–26",
            texto: "Yo sé que mi Redentor vive, y al fin se levantará sobre el polvo; y después de deshecha esta mi piel, en mi carne he de ver a Dios.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/ot/job/19?lang=spa&id=p25-p26#p25",
          },
        ],
      },
      {
        tipo: "conclusion",
        contenido: "La Resurrección no es solo una doctrina del calendario de la Iglesia que celebramos en abril. Es la promesa más personal que existe: cada persona que alguna vez vivió —incluyendo los que amás y perdiste— resucitará gracias a Jesucristo. Esa certeza transforma el duelo en esperanza, el miedo a la muerte en paz, y la vida cotidiana en algo urgente y con propósito. 'Yo sé que mi Redentor vive' —esa certeza vale la pena que la hagas tuya esta semana, no solo como doctrina, sino como convicción personal.",
      },
      {
        tipo: "cuestionario",
        preguntas: [
      ...
      },
      {
        ...
        citas: [
          ...
          },
          {
            ...
            texto: "Prestarás atención en todas sus palabras y mandamientos que te dé... pues recibirás su boca como si fuera de mí mismo.",
  ...
  },
  {
    ...
    secciones: [
      ...
      },
      {
        ...
        link: "https://www.churchofjesuschrist.org/study/general-conference/2020/04/45nelson?lang=spa&id=p31-p32#p31",
      },
      {
        tipo: "escrituras",
        citas: [
          {
            referencia: "Doctrina y Convenios 21:4–5",
            texto: "Prestarás atención en todas sus palabras y mandamientos que te dé... pues os hablará, siendo inspirado por el Espíritu Santo.",
            link: "https://www.churchofjesuschrist.org/study/scriptures/dc-testament/dc/21?lang=spa&id=p4-p5#p4",
          },
          {
            referencia: "Santiago 1:22",
          ...
          },
          {
            ...
            texto: "Los ángeles hablan por el poder del Espíritu Santo; por lo tanto, hablan las palabras de Cristo. Por tanto, os digo: festejad en las palabras de Cristo, porque he aquí, las palabras de Cristo os dirán todas las cosas que debéis hacer.",
